...
This repo is the code of an Ionic 4 starter app that we created as part of a _Getting started with Ionic 4 tutorial_. In the following tutorial your will learn the differences between Ionic 3 and Ionic 4 and all the new concepts about Ionic 4:
